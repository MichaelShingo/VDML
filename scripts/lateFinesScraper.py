import requests
payload = {
    'ctl00_MainContent$signin$usernameField': 'michael_admin',
...
https://pennmedialab.getconnect2.com/SignIn.aspx/javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("ctl00$MainContent$signin$showLocalLk", "", true, "", "", false, true))